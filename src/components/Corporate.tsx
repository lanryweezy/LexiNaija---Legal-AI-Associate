...
export const Corporate: React.FC = () => {
  ...
  return (
    <div className="h-screen bg-slate-50 flex flex-col overflow-hidden relative">
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-10 relative z-10 overflow-hidden">
        <div className="w-full max-w-5xl bg-white/70 backdrop-blur-xl rounded-[48px] shadow-[0_60px_100px_-20px_rgba(0,0,0,0.2)] border border-white flex flex-col overflow-hidden relative z-10 h-full max-h-[850px]">
